...
import 'package:dogventurehq/ui/screens/product_details/description_item.dart';
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            addW(20.w),
                            Text(
                              "AED${pModel.productSubSkuRequestModels[0].price}",
                              style: TextStyle(
                                fontSize: 16.sp,
                                fontWeight: FontWeight.bold,
                                fontFamily: ConstantStrings.kFontFamily,
                        ...
                        SizedBox(
                          ...
                          child: Center(
                            child: ListView.builder(
                              ...
                              itemCount:
                                  pModel.productSubSkuRequestModels.length,
                                ...
                                return Center(
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      height: 58.h,
                                      margin: index ==
                                              pModel.productSubSkuRequestModels
                                                      .length -
                                                  1
                                          ? null
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            "AED${pModel.productSubSkuRequestModels[index].price}",
                                            style: TextStyle(
                                              fontSize: 14.sp,
                                              fontWeight: FontWeight.bold,
                                              fontFamily:
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          children: [
            ...
            Text(
              'AED${pModel.productSubSkuRequestModels[_selectedPackageIndex].price * _quantity}',
              style: TextStyle(
                fontSize: 16.sp,
                fontWeight: FontWeight.bold,
                fontFamily: ConstantStrings.kFontFamily,
            ...
            CustomBtn(
              onPressedFn: () async {
                CartItemModel cModel = CartItemModel(
                  ...
                  unitPrice: pModel
                      .productSubSkuRequestModels[_selectedPackageIndex].price,
                  productSubSkuId: pModel
                      .productSubSkuRequestModels[_selectedPackageIndex]
                      .productSubSKUId,
                  supplierId: pModel.supplierId,
                  storeId: pModel.storeId,
                );
